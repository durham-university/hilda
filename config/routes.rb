Hilda::Engine.routes.draw do
  ...
  post 'processes/:id/module/:module/enable' => 'ingestion_processes#enable_module', as: 'ingestion_process_module_enable'
  post 'processes/:id/module/:module/disable' => 'ingestion_processes#disable_module', as: 'ingestion_process_module_disable'
